...
/**
 * Minecraft 1.20 changed GRASS to SHORT_GRASS. This class provides and
 * backwards compatibility when loading database files stored with previous
 * versions. It can be extended in the future if further enum changes are made.
 * 
 * @author tastybento
 * @since 2.0.0
 */

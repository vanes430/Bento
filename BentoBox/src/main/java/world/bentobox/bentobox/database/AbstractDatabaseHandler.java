...
public abstract class AbstractDatabaseHandler<T> {
	 ...
	 */
	private io.papermc.paper.threadedregions.scheduler.ScheduledTask asyncSaveTask;
	 ...
	 * @return the addon
	 */
	@Nullable public Addon getAddon() {
		return addon;
	}
	...
	protected AbstractDatabaseHandler(BentoBox plugin, Class<T> type, DatabaseConnector databaseConnector) {
		...
		asyncSaveTask = Bukkit.getAsyncScheduler().runAtFixedRate(plugin, t -> {
			// Check shutdown

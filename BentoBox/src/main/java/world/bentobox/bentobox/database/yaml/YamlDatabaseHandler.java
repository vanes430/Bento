 ...
 *
 * @param <T>
 *            Handles flat files for Class <T>
 */
...
public class YamlDatabaseHandler<T> extends AbstractDatabaseHandler<T> {
	 ...
	 *            - plugin
	 * @param type
	 *            - class to store in the database
	 * @param databaseConnector
	 *            - the database credentials, in this case, just the YAML functions
	 */
	...
	private void processFile(CompletableFuture<Boolean> completableFuture, T instance)
	 ...
	 */
	@NonNull private Object serialize(@Nullable Object object) {
	...
	@Nullable private Object deserialize(Object value, Class<?> clazz) {

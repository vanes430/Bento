...
public class BlueprintBlock {
	...
	/**
	 * @param creatureSpawner
	 *            the creatureSpawner to set
	 */
	...
	/**
	 * @param bannerPatterns
	 *            the banner Patterns to set
	 * @since 1.8.0
	 */
	...
	/**
	 * @param itemsAdderBlock
	 *            the itemsAdderBlock to set
	 */

...
public class BlueprintTrialSpawner {
	...
	private Map<LootTableSerial, Integer> convertToLootTableSerial(Map<LootTable, Integer> possibleRewards) {
		...
		return possibleRewards.entrySet().stream().collect(Collectors.toMap(entry -> { // Convert LootTable to
																						// LootTableSerial
	...
	// Method to convert Map<LootTableSerial, Integer> back to Map<LootTable,
	// Integer>
	...
	public boolean configTrialSpawner(TrialSpawnerConfiguration spawner) {
		...
		spawner.setPossibleRewards(convertToLootTable(lootTableMap)); // Note to future me: if the weight in the map is
																		// zero code stops running at this pojnt!
	...
	/**
	 * @param addSpawnsB4Cool
	 *            the addSpawnsB4Cool to set
	 */
	...
	/**
	 * @param baseSpawnsB4Cool
	 *            the baseSpawnsB4Cool to set
	 */

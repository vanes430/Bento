...
public class Settings implements ConfigObject {
	...
	private boolean logGithubDownloadData = false;
	...
	/**
	 * @param clearRadius
	 *            the clearRadius to set. Cannot be negative.
	 */
	...
	/**
	 * @param inviteConfirmation
	 *            the inviteConfirmation to set
	 * @since 1.8.0
	 */
	 ...
	 * 
	 * @param keepPreviousIslandOnReset
	 *            {@code true} if islands, when reset, should be kept; {@code false}
	 *            otherwise.
	 * @since 1.13.0
	 */
	 ...
	 * in Panels.
	 * 
	 * @param panelFillerMaterial
	 *            the Material of the item to preferably use when one needs to fill
	 *            gaps in Panels.
	 * @since 1.14.0
	 */
	 ...
	 *
	 * @param useCacheServer
	 *            the use cache server
	 * @since 1.16.0
	 */
	 ...
	 *
	 * @param ticksBetweenCalls
	 *            the ticks between calls
	 * @since 1.16.0
	 */
	...
	/**
	 * @param minPortalSearchRadius
	 *            the minPortalSearchRadius to set
	 */
	 ...
	 *
	 * @param safeSpotSearchVerticalRange
	 *            the safe spot search vertical range
	 */
	 ...
	 *
	 * @param customPoolProperties
	 *            the custom pool properties
	 */
	 ...
	 *
	 * @param safeSpotSearchRange
	 *            the safe spot search range
	 */
	...
	/**
	 * @param hideUsedBlueprints
	 *            the hideUsedBlueprints to set
	 */
	...
	/**
	 * @param overrideSafetyCheck
	 *            the overrideSafetyCheck to set
	 */
	...
	/**
	 * @param clickCooldownMs
	 *            the clickCooldownMs to set
	 */
	...
	/**
	 * @param islandPurgeLevel
	 *            the islandPurgeLevel to set
	 */

...
public class ItemParser {
	 ...
	 * @param text
	 *            String value of item stack.
	 * @param defaultItemStack
	 *            Material that should be returned if parsing failed.
	 * @return ItemStack of parsed item or defaultItemStack.
	 */
	@Nullable public static ItemStack parse(@Nullable String text, @Nullable ItemStack defaultItemStack) {
	 ...
	 * @return ItemStack of parsed item or defaultItemStack.
	 */
	@Nullable private static ItemStack parseOld(@Nullable String text, @Nullable ItemStack defaultItemStack) {
	 ...
	 * 
	 * @param returnValue
	 *            Item stack that should be updated.
	 ...
	 * 
	 * @param part
	 *            String array that contains 2 elements.
	 ...
	 * 
	 * @param part
	 *            String array that contains 3 elements.
	 ...
	 * 
	 * @param part
	 *            String array that contains 6 elements.
	 ...
	 * 
	 * @link <a href=
	 *       "https://hub.spigotmc.org/javadocs/spigot/org/bukkit/potion/PotionType.html">Potion
	 *       Type</a>
	 * @param part
	 *            String array that contains 3 elements.
	 * @return Potion with given properties.
	...
	private static ItemStack parsePotion(String[] part) {
		...
		/*
		 * # Format POTION:<POTION_TYPE>:QTY # Potion Type can be found out in:
		 * https://hub.spigotmc.org/javadocs/spigot/org/bukkit/potion/PotionType.html #
		 * Examples: # POTION:STRENGTH:1 # POTION:INSTANT_DAMAGE:2 # POTION:JUMP:1 #
	 ...
	 * 
	 * @param part
	 *            String array that contains at least 2 elements.
		...
		try {
			if (playerHead.getItemMeta() instanceof SkullMeta meta) {
				...
				if (part[1].length() < 17) {
					...
					profile = Bukkit.createPlayerProfile(UUID.fromString(

...
/**
 * Class to store pairs of objects, e.g. coordinates. This could be done now as
 * a record, but due to legacy code referencing it, it stays as a class.
 * 
 * @author tastybento
 *
 * @param <X>
 *            the x part of the pair
 * @param <Z>
 *            the z part of the pair
 */

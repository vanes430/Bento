...
public abstract class AbstractPanel {
	...
	/**
	 * This variable holds world where panel is opened. Without it panel cannot be
	 * opened.
	 */
	String mainLabel;
	...
	/**
	 * This method returns if panel with the requested name is located in
	 * GameModeAddon folder.
	 * 
	 * @param addon
	 *            GameModeAddon that need to be checked.
	 * @param name
	 *            Name of the panel.

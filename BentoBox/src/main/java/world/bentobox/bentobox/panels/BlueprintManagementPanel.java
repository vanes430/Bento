...
public class BlueprintManagementPanel {
	 ...
	 *            - BentoBox
	 * @param user
	 *            - user to see the panel
	 * @param addon
	 *            - game mode addon requesting the panel
	 */
	 ...
	 *            - the GameMode Addon
	 * @param pos
	 *            - the position where this icon will be placed - the description
	 *            changes
	 * @param bb
	 *            - the blueprint bundle this blueprint is in, if any
	 * @param blueprint
	 *            - blueprint itself
	 * @return a panel item
	 */

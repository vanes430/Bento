...
/**
 * This class loader is responsible for loading an addon's JAR file, its
 * classes, and its {@code addon.yml} metadata.
 * <p>
 ...
 * <p>
 * This approach is now rarely used as most addons are now Plugin-based and so
 * are loaded by the server as plugins.
 *
...
public class AddonClassLoader extends URLClassLoader {
	 ...
	 * @param data
	 *            The addon's metadata from {@code addon.yml}.
	 * @param jarFile
	 *            The addon's JAR file.
	 * @param parent
	 *            The parent class loader.
	 * @throws InvalidAddonInheritException
	 *             If the main class does not extend {@link Addon}.
	 * @throws MalformedURLException
	 *             If the JAR file path is invalid.
	 * @throws InvalidDescriptionException
	 *             If the addon cannot be loaded.
	 * @throws InvalidAddonDescriptionException
	 *             If the {@code addon.yml} is invalid.
	 * @throws InstantiationException
	 *             If the addon's main class cannot be instantiated.
	 * @throws IllegalAccessException
	 *             If the addon's main class constructor is not accessible.
	 * @throws InvocationTargetException
	 *             If the addon's constructor throws an exception.
	 * @throws NoSuchMethodException
	 *             If the addon's main class has no default constructor.
	 */
	 ...
	 *
	 * @param data
	 *            The YAML configuration from {@code addon.yml}.
	 * @return An {@link AddonDescription} instance.
	 * @throws InvalidAddonDescriptionException
	 *             If the {@code addon.yml} is missing required fields or contains
	 *             invalid values.
	 */
	@NonNull public static AddonDescription asDescription(YamlConfiguration data) throws InvalidAddonDescriptionException {
		// Validate addon.yml
	 ...
	 */
	@Override
	@Nullable protected Class<?> findClass(String name) {
	 ...
	 * <p>
	 * This custom implementation enables classes in one addon to be found by
	 * another. The loading strategy is as follows:
	 * <ol>
	 * <li>Check the local cache for this class loader.</li>
	 * <li>If not found, check the global cache in {@link AddonsManager} (if
	 * {@code checkGlobal} is true).</li>
	 * <li>If still not found, try to load the class from the addon's JAR file.</li>
	 * <li>If loaded successfully from the JAR, register it in the global
	 * cache.</li>
	 ...
	 * @param checkGlobal
	 *            If true, check for classes loaded by other addons.
	 * @return The loaded {@link Class}, or {@code null} if the class could not be
	 *         found.
	 */

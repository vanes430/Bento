...
public class IslandEvent extends IslandBaseEvent {
	 ...
	 * @param playerUUID
	 *            - the player's UUID involved in the event
	 * @param admin
	 *            - true if this is due to an admin event
	 * @param location
	 *            - location of event
	 * @param reason
	 *            - see {@link #getReason()}
	...
	public enum Reason {
		 ...
		 * island has been deleted but after everything else. i.e., island pasted,
		 * player teleported, etc.
		 */
		RESETTED,
		/**
	...
	public static class IslandEventBuilder {
		 ...
		 * @since 1.6.0
		 */
		@NonNull public IslandEventBuilder blueprintBundle(@NonNull BlueprintBundle blueprintBundle) {
		 ...
		 * 
		 * @param newRange
		 *            New value of protection range.
		 * @param oldRange
		 *            Old value of protection range.
		 * @since 1.11.0
		 */
		@NonNull public IslandEventBuilder protectionRange(int newRange, int oldRange) {
		 ...
		 * @since 1.13.0
		 */
		@NonNull public IslandEventBuilder rankChange(int oldRank, int newRank) {
		...
		private IslandBaseEvent getEvent() {
			return switch (reason) {
				...
				case RESET -> new IslandResetEvent(island, player, admin, location, oldIsland);

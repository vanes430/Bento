 ...
 * <p>
 * This command is automatically added to every {@link CompositeCommand} that
 * doesn't define its own help sub-command. It displays command usage,
 * parameters, and descriptions in a hierarchical format, respecting permissions
 * and command visibility settings.
 * <p>
 * Features:
 * <ul>
...
public class DefaultHelpCommand extends CompositeCommand {
	...
	/**
	 * Creates a help command for the specified parent command. Inherits permissions
	 * and parameters from the parent.
	 *
	 * @param parent
	 *            The command that this help command belongs to
	 */
	...
	/**
	 * Recursively displays help for all sub-commands at the specified depth. Skips
	 * the help command itself to avoid infinite recursion.
	 *
	 * @param user
	 *            The user to show help to
	 * @param newDepth
	 *            The depth level for sub-commands
	 */
	...
	/**
	 * Displays formatted help for a single command, respecting permissions and
	 * command type.
	 *
	 * @param user
	 *            The user to show help to
	 ...
	 * @return true if help display should stop (e.g., no permission), false to
	 *         continue
	 */

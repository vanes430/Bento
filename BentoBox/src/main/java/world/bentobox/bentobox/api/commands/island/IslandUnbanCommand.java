 ...
 * <p>
 * This command allows island owners and team members to remove bans from
 * players, allowing them to visit the island again.
 * <p>
 * Features:
 * <ul>
 ...
 * </ul>
 * <p>
 * Permission: {@code island.ban} Aliases: unban, pardon
 *
 * @author tastybento
 * @since 1.0
 */
public class IslandUnbanCommand extends CompositeCommand {
	...
	/**
	 * Cached UUID of the player to be unbanned. Set during canExecute and used in
	 * execute.
	 */
	...
	/**
	 * Provides tab completion for currently banned player names. Filters

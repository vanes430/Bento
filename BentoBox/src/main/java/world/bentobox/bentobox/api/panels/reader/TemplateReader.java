...
public class TemplateReader {
	 ...
	 *            Section that contains panel template data.
	 ...
	 * 
	 * @param section
	 *            Configuration section that contains force-shown path.
	 ...
	 * 
	 * @param section
	 *            Section that should contain all information about the panel item
	 *            template.
	 * @return PanelItemTemplate that should represent button from a section.
	 */
	@Nullable private static ItemTemplateRecord readPanelItemTemplate(@Nullable ConfigurationSection section) {
	 ...
	 * @return PanelItemTemplate that should represent button from a section.
	 */
	@Nullable private static ItemTemplateRecord readPanelItemTemplate(@Nullable ConfigurationSection section, String itemKey,

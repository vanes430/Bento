 ...
 * </ul>
 * <p>
 * Command usage: /island deletehome &lt;name&gt; <br>
...
public class IslandDeletehomeCommand extends ConfirmableCommand {
	 ...
	 * 
	 * @param island
	 *            The island containing the home
	 * @param user
	 *            The user deleting the home
	 * @param name
	...
	/**
	 * Creates a mapping of home names to their respective islands. Handles multiple
	 * islands and multiple homes per island.
	 * 
	 * @param user
	 *            The user whose homes to map

 ...
 * <p>
 * This command allows island members to grant temporary cooperative access to
 * other players. Coop members have limited permissions on the island but are
 * not full team members.
 * <p>
 * Features:
 * <ul>
...
public class IslandTeamCoopCommand extends CompositeCommand {
	 ...
	 * <li>Without confirmation: Immediately grants coop rank if space
	 * available</li>
	 * </ul>
	 */
	@Override
	...
	/**
	 * Provides tab completion for online player names. Requires at least one
	 * character to avoid showing all players.
	 */
	@Override

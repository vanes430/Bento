 ...
 * <p>
 * This command removes the custom name from an island, reverting it to the
 * default naming scheme. It requires the same permission as the name command
 * and appropriate rank to execute.
 * <p>
 * Features:
 * <ul>
...
public class IslandResetnameCommand extends CompositeCommand {
	...
	/**
	 * Removes the custom name from the island. Sets the island name to null, which
	 * reverts it to the default naming scheme.
	 */
	@Override

 ...
 * <p>
 * This command allows island owners and team members to remove visitors from
 * their island. Unlike banning, expelling is temporary - players can return
 * later.
 * <p>
 * Features:
 * <ul>
...
public class IslandExpelCommand extends CompositeCommand {
	...
	/**
	 * Provides tab completion for online players currently on the island. Excludes:
	 * <ul>

...
public class AdminRangeDisplayCommand extends CompositeCommand {
	...
	private final Map<User, io.papermc.paper.threadedregions.scheduler.ScheduledTask> displayRanges = new HashMap<>();
	...
	private void showZones(User user) {
		...
		displayRanges.put(user, user.getPlayer().getScheduler().runAtFixedRate(getPlugin(), t -> {

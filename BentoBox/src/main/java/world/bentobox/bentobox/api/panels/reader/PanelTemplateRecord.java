 ...
 *            the title of GUI
 * @param border
 *            the border block for GUI
 * @param background
 *            the background block for GUI.
 * @param forcedRows
 *            the array of boolean that indicate which rows must be force
 *            loaded.
 * @param content
 *            The 2D array of ItemTemplateRecords
 *
 * @since 1.17.3
 */
public record PanelTemplateRecord(Panel.Type type, @Nullable String title, @Nullable TemplateItem border,
	 ...
	 * 
	 * @param rowIndex
	 *            row index of content array
	 * @param columnIndex
	 *            column index of content array.
	 * @param panelItemTemplate
	 *            item template record that must be added.
	 */
	...
	public boolean equals(Object obj) {
		...
		if (!(obj instanceof PanelTemplateRecord(Panel.Type type1, String title1, TemplateItem border1, TemplateItem background1, boolean[] rows, ItemTemplateRecord[][] content1))) {
			return false;
		}

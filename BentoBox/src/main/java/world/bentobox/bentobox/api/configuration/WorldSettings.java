...
public interface WorldSettings extends ConfigObject {
	...
	/**
	 * @return the endGenerateStructures - if false, no structures (like End Exit
	 *         Island) will be generated in the End
	 * @since 2.0.0
	 */
	default boolean isEndGenerateStructures() {
		return false; // Default: void End without structures
	}

	/**
	 * @return the endGenerateFakeIslands - if true, generates 3x3 fake islands in
	 *         End to create distance from dragon spawn
	 * @since 2.0.0
	 */
	default boolean isEndGenerateFakeIslands() {
		return true; // Default: generate fake islands
	}
	 ...
	 */
	@NonNull List<String> getOnJoinCommands();
	 ...
	 */
	@NonNull List<String> getOnLeaveCommands();
	 ...
	 * @see #getOnJoinCommands()
	 */
	@NonNull default List<String> getOnRespawnCommands() {
		return Collections.emptyList();
	}
	...
	/**
	 * Returns default sub-command for users when they execute main user command,
	 * and they do not have an island. If defined sub-command does not exist in
	...
	/**
	 * Remove islands when players join a team and not allow players to have other
	 * islands if they are in a team.
	 * 

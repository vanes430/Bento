...
/**
 * Fired when a player requests info about an island Cancellation has no effect.
 * 
 * @since 1.24.0
 */
public class IslandInfoEvent extends IslandBaseEvent {
	 ...
	 *            island
	 * @param player
	 *            player asking for the info
	 * @param admin
	 *            true if this is an admin request
	 * @param location
	 *            location of the player asking for the info
	 * @param addon
	 *            the addon parent that is calling this info command, e.g.,
	 *            BSkyBlock
	 */

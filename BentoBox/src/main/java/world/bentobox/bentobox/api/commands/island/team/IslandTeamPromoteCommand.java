...
/**
 * Command that handles promoting and demoting team members within an island
 * team hierarchy.
 * <p>
 * Features:
 * <ul>
 ...
 * <li>Prevents invalid rank changes (self-promotion, promoting above own
 * rank)</li>
...
public class IslandTeamPromoteCommand extends CompositeCommand {
	...
	/**
	 * Validates command execution conditions. Checks:
	 * <ul>
	...
	/**
	 * Handles the rank change logic. For promotion: - Increases rank but stays
	 * below owner - Must be at least member rank For demotion: - Decreases rank but
	 * not below member
	 * <p>
	...
	/**
	 * Provides tab completion for team member names. Only shows members of the
	 * user's island.
	 */
	@Override

...
public class AdminTeamSetownerCommand extends ConfirmableCommand {
	...
	public boolean execute(User user, String label, List<String> args) {
		...
		if (!checkForceFlag(user, args, user.getTranslation("commands.admin.team.setowner.confirmation",
				TextVariables.NAME, args.getFirst(), TextVariables.XYZ, Util.xyz(island.getCenter().toVector())))) {
			return false;
		}
		changeOwner(user);
		return true;

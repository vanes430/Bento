 ...
 * <p>
 * This command opens a GUI panel displaying all available home locations for a
 * player's islands. Players can view and teleport to their homes through this
 * interface.
 * <p>
 * Features:
 * <ul>
...
public class IslandHomesCommand extends CompositeCommand {
	 ...
	 * <p>
	 * Checks if the player has at least one island in the world. Without an island,
	 * they cannot have any homes to display.
	 */
	@Override
	...
	/**
	 * Opens the homes GUI panel for the user. Panel display is handled by
	 * {@link IslandHomesPanel}.
	 */
	@Override

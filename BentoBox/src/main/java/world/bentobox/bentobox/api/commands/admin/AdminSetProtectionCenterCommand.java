...
public class AdminSetProtectionCenterCommand extends ConfirmableCommand {
	...
	public boolean execute(User user, String label, List<String> args) {
		...
		// Confirm
		if (!checkForceFlag(user, args, user.getTranslation("commands.admin.setprotectionlocation.confirmation",
				TextVariables.XYZ, Util.xyz(targetLoc.toVector())))) {
			return false;
		}
		setLocation(user);
		return true;

 ...
 * Commands:
 * <ul>
 * <li><b>/bsb maxhomes &lt;player&gt; &lt;number&gt;</b> - Sets the maximum
 * number of homes for each island where the player is the owner. This could
 * apply to multiple islands.</li>
 * <li><b>/bsb maxhomes &lt;player&gt; &lt;number&gt; [island name]</b> - Sets
 * the maximum number of homes for a specific named island where the player is
 * the owner.</li>
 * <li><b>/bsb maxhomes &lt;number&gt;</b> - Sets the maximum number of homes
 * for the island you are standing on (in-game only).</li>
 * </ul>
 * 
 * @author tastybento
 * @since 2.6.0
...
public class AdminMaxHomesCommand extends ConfirmableCommand {
	...
	public boolean canExecute(User user, String label, List<String> args) {
		...
		if (args.size() > 2) {
			...
			final String name = String.join(" ", args.subList(2, args.size())); // Join all the args from here with
																				// spaces

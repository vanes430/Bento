 ...
 * <p>
 * Instances of this class are typically created using the {@link Builder}
 * pattern.
 * <p>
 * Example usage:
 * 
 ...
 * 		.description("My Addon Description").authors("Author1", "Author2")
 * 		.dependencies(Arrays.asList("Dep1", "Dep2")).softDependencies(Arrays.asList("SoftDep1")).metrics(true)
 * 		.repository("Owner/RepoName").icon(Material.DIAMOND).apiVersion("1.11.0").build();
 * </pre>
 * </p>
 *
...
public final class AddonDescription {
	 ...
	 */
	@NonNull public List<String> getSoftDependencies() {
	 ...
	 * @since 1.5.0
	 */
	@NonNull public Material getIcon() {
		return icon;
	}
	 ...
	 * @since 1.13.0
	 */
	@Nullable public ConfigurationSection getPermissions() {
		return permissions;
	}
	...
	public static class Builder {
		...
		@NonNull private List<String> dependencies = new ArrayList<>();
		@NonNull private List<String> softDependencies = new ArrayList<>();
		private boolean metrics = true;
		@NonNull private String repository = "";
		@NonNull private Material icon = Material.PAPER;
		@NonNull private String apiVersion = "1";
		@Nullable private ConfigurationSection permissions;
		...
		@NonNull public Builder authors(@NonNull String... authors) {
			this.authors = Arrays.asList(authors);
			return this;
		}

		@NonNull public Builder dependencies(@NonNull List<String> dependencies) {
			this.dependencies = dependencies;
			return this;
		}

		@NonNull public Builder softDependencies(@NonNull List<String> softDependencies) {
		 ...
		 * @since 1.1
		 */
		@NonNull public Builder metrics(boolean metrics) {
		 ...
		 * @since 1.3.0
		 */
		@NonNull public Builder repository(@NonNull String repository) {
		 ...
		 * 
		 * @param icon
		 *            Material to set as the icon. Default is {@link Material#PAPER}.
		 * @since 1.5.0
		 */
		@NonNull public Builder icon(@NonNull Material icon) {
			this.icon = icon;
			return this;
		}
		 ...
		 * 
		 * @param apiVersion
		 *            the minimum BentoBox version this addon requires in order to work
		 *            properly.
		 * @since 1.11.0
		 * @see AddonDescription#getApiVersion()
		 */
		@NonNull public Builder apiVersion(@NonNull String apiVersion) {
			this.apiVersion = apiVersion;
			return this;
		}

		@NonNull public AddonDescription build() {
		 ...
		 * @since 1.13.0
		 */
		@NonNull public Builder permissions(ConfigurationSection permissions) {

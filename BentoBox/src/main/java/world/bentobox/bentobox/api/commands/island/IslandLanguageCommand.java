 ...
 * <p>
 * This command allows players to change their personal language settings. It
 * can be used either with a language code argument or through a GUI panel.
 * <p>
 * Features:
 * <ul>
 ...
 * </ul>
 * <p>
 * Permission: {@code island.language} Aliases: language, lang
 *
 * @author Poslovitch
 * @since 1.0
 */
public class IslandLanguageCommand extends CompositeCommand {
	...
	/**
	 * Provides tab completion for available language codes. Lists all languages
	 * that are currently available in the plugin.
	 */
	@Override

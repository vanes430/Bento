...
public class Flag implements Comparable<Flag> {
	 ...
	 *            - true means it is allowed. false means it is not allowed
	 */
	 ...
	 * depending on whom the user is and where they are.
	 * 
	 * @param plugin
	 *            - plugin
	 * @param user
	 *            - user that will see this flag
	 * @param world
	 *            - the world this flag is being shown for. If island is present,
	 *            then world is the same as the island.
	 * @param island
	 *            - target island, if any
	 * @param invisible
	 *            - true if this flag is not visible to players
	 * @return - PanelItem for this flag or null if item is invisible to user
	 */
	@Nullable public PanelItem toPanelItem(BentoBox plugin, User user, World world, @Nullable Island island, boolean invisible) {
		// Invisibility
	 ...
	 * 
	 * @param locale
	 *            locale (language) to which this name should be assigned. Assigning
	 *            to {@code Locale.US} will make this the default
	 * @param name
	 *            the translated name for this flag
	 ...
	 *            to {@code Locale.US} will make this the default
	 * @param description
	 *            the translated description for this flag
	 * @return true if successful, false if the locale is unknown to this server.
	 *         See
	 *         {@link world.bentobox.bentobox.managers.LocalesManager#getAvailableLocales(boolean sort)}
	 * @since 1.22.1
	...
	public static class Builder {
		 ...
		 * 
		 * @param id
		 *            - a unique id that MUST be the same as the enum of the flag
		 * @param icon
		 *            - a material that will be used as the icon in the GUI
		 */
		 ...
		 * 
		 * @param type
		 *            {@link Type#PROTECTION}, {@link Type#SETTING} or
		...
		/**
		 * When should sub-flags be hidden, if ever {@see HideWhen}
		 * 
		 * @param hideWhen
		 *            hide when indicator
		 * @return Builder - flag builder

 ...
 * <p>
 * This command shows information about neighboring islands in the four cardinal
 * directions (North, East, South, West) at a distance of twice the island
 * spacing.
 * <p>
 * Features:
 * <ul>
...
public class IslandNearCommand extends CompositeCommand {
	...
	/**
	 * The cardinal directions to check for neighboring islands. Order determines
	 * the display order in the command output.
	 */
	...
	/**
	 * Gets the display name for an island. Priority: 1. Custom island name 2.
	 * "Unowned" for unowned islands 3. Owner's name
	 *
	 * @param user
	 *            The user executing the command
	 * @param island
	 *            The island to get the name for

...
public class TemplatedPanel extends Panel {
	 ...
	 * 
	 * @param builder
	 *            Builder that contains all information about the panel that must be
	 *            generated.
	 */
	 ...
	 */
	@NonNull private Map<Integer, PanelItem> populateInventoryPanel(PanelItem[][] itemArray) {
	 ...
	 * 
	 * @param itemArray
	 *            The double array with items into panel
	 */
	 ...
	 * 
	 * @param rec
	 *            Template of the button that must be created.
	 * @return PanelItem of the template, otherwise null.
	 */
	@Nullable private PanelItem makeButton(@Nullable ItemTemplateRecord rec) {
		if (rec == null) {
	 ...
	 */
	@Nullable private PanelItem makeAddonButton(@NonNull ItemTemplateRecord rec) {
		// Get object type.
	 ...
	 * 
	 * @param rec
	 *            Record which fallback must be created.
	 * @return PanelItem if fallback was creates successfully, otherwise null.
	 */
	@Nullable private PanelItem makeFallBack(@Nullable ItemTemplateRecord rec) {
	 ...
	 * 
	 * @param rec
	 *            Record that must be translated.
	 ...
	 * 
	 * @param slot
	 *            Index of object in current panel.
	 * @param parentPanel
	 *            The parent panel for current Item.
	 */
	public record ItemSlot(int slot, TemplatedPanel parentPanel) {
		 ...
		 * 
		 * @return Map that links button type to amount in the gui. Use
		 *         {@link #amount(String)} instead.
		 */
		 ...
		 *            Type of the button.
		 * @param defaultValue
		 *            The default value if the type is not found
		 * @return Number of slots in panel.
		 */

...
public class LocalesManager {
	...
	private final Map<Locale, BentoBoxLocale> languages = new ConcurrentHashMap<>();
	 ...
	 *            a reference that can be found in a locale file
	 * @param defaultText
	 *            to return if the reference cannot be found anywhere
	 * @return the translated String from the User's locale or from the server's
	 *         locale or from the en-US locale, or null.
	 */
	 ...
	 *         locale, or null.
	 */
	@Nullable public String get(String reference) {
	 ...
	 *            a reference that can be found in a locale file.
	 * @param defaultText
	 *            text to return if the reference cannot be found anywhere.
	 * @return the translated String from the server's locale or from the en-US
	 *         locale, or default.
	 */
	 ...
	 * 
	 * @param user
	 *            the user to get the locale, not null.
	 ...
	 *
	 * @param localeFolder
	 *            - locale folder location relative to the plugin's data folder
	 */
	 ...
	 * 
	 * @param sort
	 *            - if true, the locales will be sorted by language tag
	 ...
	 * 
	 * @param locale
	 *            the locale, not null. Consider using
	 ...
	 *
	 * @param fix
	 *            whether or not locale files with missing translations should be

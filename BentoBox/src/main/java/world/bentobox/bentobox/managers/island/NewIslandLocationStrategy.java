...
public interface NewIslandLocationStrategy {
	...
	/**
	 * Provide the next location for an island based on the world and the user doing
	 * the request. This allows the user to have an effect on the location, if
	 * required. Default location is the same as {@link #getNextLocation(World)}
	 * 
	 * @param world
	 *            - world
	 * @param user

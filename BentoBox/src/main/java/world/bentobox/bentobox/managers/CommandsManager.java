...
public class CommandsManager {
	...
	@NonNull private final Map<@NonNull String, @NonNull CompositeCommand> commands = new ConcurrentHashMap<>();
	 ...
	 */
	@Nullable public CompositeCommand getCommand(@NonNull String command) {
	 ...
	 * @return the commands
	 */
	@NonNull public Map<String, CompositeCommand> getCommands() {
		return commands;
	}
	 ...
	 */
	@NonNull public Set<String> listCommands() {

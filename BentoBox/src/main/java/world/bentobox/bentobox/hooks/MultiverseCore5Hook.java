...
public class MultiverseCore5Hook extends Hook implements WorldManagementHook {
	 ...
	 *            - world to register
	 * @param islandWorld
	 *            - if true, then this is an island world
	 */
	@Override
	public void registerWorld(World world, boolean islandWorld) {
		...
		api.getWorldManager().importWorld(
				ImportWorldOptions.worldName(world.getName()).environment(world.getEnvironment()).generator(generator))

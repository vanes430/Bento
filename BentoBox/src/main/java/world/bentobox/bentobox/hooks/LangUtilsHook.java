...
public class LangUtilsHook extends Hook {
	 ...
	 *            The item
	 * @param user
	 *            the User's locale will be used for translation.
	 ...
	 *
	 * @param itemStack
	 *            the ItemStack whose name will be translated.
	 * @param user
	 *            the User's locale will be used for translation.
	 ...
	 *
	 * @param material
	 *            the Bukkit material whose name will be translated.
	 * @param user
	 *            the User's locale will be used for translation.
	 ...
	 *
	 * @param entityType
	 *            the EntityType whose name will be translated.
	 * @param user
	 *            the User's locale will be used for translation.
	 ...
	 *
	 * @param biome
	 *            the Biome whose name will be translated.
	 * @param user
	 *            the User's locale will be used for translation.
	 ...
	 *
	 * @param entry
	 *            The Entry of an enchantment with level The type is
	 ...
	 *            The enchantment level.
	 * @param user
	 *            The user's language will be used for translation.
	 ...
	 *
	 * @param potionType
	 *            The basic effect of PotionType.
	 * @param user
	 *            The user's language will be used for translation.
	 ...
	 *
	 * @param meta
	 *            Metadata carrying information about tropical fish.
	 * @param user
	 *            The return value is localized according to the user's locale.
	 * @return If variant is predefined, return the name of the tropical fish,
	 *         otherwise return null.
	 */
	@Nullable public static String getPredefinedTropicalFishName(TropicalFishBucketMeta meta, User user) {
		if (hooked) {
	 ...
	 *
	 * @param pattern
	 *            Contains the color banner pattern.
	 * @param user
	 *            The user's language will be used for translation.
	 ...
	 *
	 * @param material
	 *            Material for music records.
	 * @param user
	 *            This parameter is temporarily useless and is reserved for possible
	 *            future changes.
	 * @return If the given material is a music disk, the description of the music
	 *         disk is returned. Otherwise, return NULL.
	 */
	@Nullable public static String getMusicDiskDesc(Material material, User user) {

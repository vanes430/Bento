...
public abstract class PlaceholderHook extends Hook {
	 ...
	 * 
	 * @param placeholder
	 *            the placeholder to register, not null
	 * @param replacer
	 *            its replacement, not null
	 * @since 1.5.0
	 */
	 ...
	 * 
	 * @param player
	 *            the Player to get the placeholders for.
	 * @param string
	 ...
	 * @since 1.5.0
	 */
	@NonNull public abstract String replacePlaceholders(@NonNull Player player, @NonNull String string);

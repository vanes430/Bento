...
public class VaultHook extends Hook {
	 ...
	 *            the User to get the balance from.
	 * @param world
	 *            the world where is the balance. If null, return general balance.
	 ...
	 * 
	 * @param user
	 *            the User to withdraw from. Must be a Player or an OfflinePlayer.
	 * @param amount
	 ...
	 * @param world
	 *            the world where is the balance, can be null.
	 * @return the EconomyResponse of this withdrawal.
	 */
	 ...
	 * 
	 * @param user
	 *            the User to deposit to. Must be a Player or an OfflinePlayer.
	 * @param amount
	 ...
	 *            the User to check.
	 * @param amount
	 *            the amount to check. Must be positive.

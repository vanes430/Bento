...
public class CleanSuperFlatListener extends FlagListener {
	 ...
	 */
	@NonNull private final Queue<Chunk> chunkQueue = new LinkedList<>();
	...
	public void onChunkLoad(ChunkLoadEvent e) {
		...
		if (this.task == null || this.task.isCancelled()) {
			this.task = Bukkit.getGlobalRegionScheduler().runAtFixedRate(this.plugin, t -> this.cleanChunk(world), 1L,
					1L);
		}
	}
	 ...
	 * 
	 * @param world
	 *            The world that must be cleared.
	 */

...
public class EnterExitListener extends FlagListener {
	 ...
	 * 
	 * @param user
	 *            the User to send the notification to, not null.
	 * @param island
	 *            the island the user exited, not null.
	 * @since 1.4.0
	 */
	 ...
	 *            the User to send the notification to, not null.
	 * @param island
	 *            the island the user entered, not null.
	 * @since 1.4.0
	 */

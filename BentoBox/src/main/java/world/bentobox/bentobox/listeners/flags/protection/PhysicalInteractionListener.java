...
/**
 * Listener for {@link Flags#CROP_TRAMPLE}, {@link Flags#PRESSURE_PLATE},
 * {@link Flags#TURTLE_EGGS}, {@link Flags#BUTTON}
 * 
 * @author tastybento
 *
 */
public class PhysicalInteractionListener extends FlagListener {
	...
	/**
	 * Protects buttons and plates, etc. from being activated by projectiles that
	 * explode
	 * 
	 * @param e
	 *            - event

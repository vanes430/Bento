...
public class ChunkGeneratorWorld extends ChunkGenerator {
			...
			for (int z = 0; z < 16; z++) {
				...
				for (int y = worldInfo.getMinHeight(); y < 25 + n; y++) {
					chunkData.setBlock(x, y, z,
							rand.nextBoolean()
									? floorMats.get(worldInfo.getEnvironment()).top()
	...
	@Override
	public org.bukkit.Location getFixedSpawnLocation(@NonNull World world, @NonNull Random random) {
		return new org.bukkit.Location(world, 0, addon.getSettings().getSeaHeight() + 1, 0);
	}

...
public class AISettings implements WorldSettings {
	...
	private int islandDistance = 300;
	...
	private int islandProtectionRange = 300;
	...
	private int islandStartX = 100000;

	@ConfigEntry(path = "world.start-z", needsReset = true)
	private int islandStartZ = 100000;
	...
	@ConfigComment("Generate structures in The End (e.g., End Exit Island platform at 0,MaxY,0).")
	@ConfigComment("If false, the End will be a void world with no structures.")
	@ConfigEntry(path = "world.end.generate-structures", since = "2.0.0")
	private boolean endGenerateStructures = true;

	@ConfigComment("Generate 3x3 fake islands in The End to create distance from dragon spawn point.")
	@ConfigComment("This creates a buffer zone so player islands spawn further from (0,0).")
	@ConfigEntry(path = "world.end.generate-fake-islands", since = "2.0.0")
	private boolean endGenerateFakeIslands = true;
	...
	private boolean pasteMissingIslands = true;
	...
	/**
	 * @return the endGenerateStructures
	 */
	@Override
	public boolean isEndGenerateStructures() {
		return endGenerateStructures;
	}
	/**
	 * @return the endGenerateFakeIslands
	 */
	public boolean isEndGenerateFakeIslands() {
		return endGenerateFakeIslands;
	}
	/**
	 */
	@Override
	...
	/**
	 * @param acidDamageOp
	 *            the acidDamageOp to set
	 */
	public void setAcidDamageOp(boolean acidDamageOp) {
		this.acidDamageOp = acidDamageOp;
	}
	/**
	 * @param acidDestroyItemTime
	 *            the acidDestroyItemTime to set
	 */
	...
	/**
	 * @param defaultBiome
	 *            the defaultBiome to set
	 */
	public void setDefaultBiome(Biome defaultBiome) {
		this.defaultBiome = defaultBiome;
	}
	/**
	 * @param defaultGameMode
	 *            the defaultGameMode to set
	 */
	...
	/**
	 * @param defaultIslandSettings
	 *            the defaultIslandSettings to set
	 */
	...
	/**
	 * @param endGenerate
	 *            the endGenerate to set
	 */
	public void setEndGenerate(boolean endGenerate) {
		this.endGenerate = endGenerate;
	}
	/**
	 * @param endGenerateStructures
	 *            the endGenerateStructures to set
	 */
	public void setEndGenerateStructures(boolean endGenerateStructures) {
		this.endGenerateStructures = endGenerateStructures;
	}
	/**
	 * @param endGenerateFakeIslands
	 *            the endGenerateFakeIslands to set
	 */
	public void setEndGenerateFakeIslands(boolean endGenerateFakeIslands) {
		this.endGenerateFakeIslands = endGenerateFakeIslands;
	}
	/**
	 * @param endIslands
	 *            the endIslands to set
	 */
	...
	/**
	 * @param helmetProtection
	 *            the helmetProtection to set
	 */
	...
	/**
	 * @param islandCommand
	 *            what you want your island command to be
	 */
	...
	/**
	 * @param islandProtectionRange
	 *            the islandProtectionRange to set
	 */
	...
	/**
	 * @param netherGenerate
	 *            the netherGenerate to set
	 */
	...
	/**
	 * @param onJoinResetInventory
	 *            the onJoinResetInventory to set
	 */
	...
	/**
	 * @param onJoinResetMoney
	 *            the onJoinResetMoney to set
	 */
	public void setOnJoinResetMoney(boolean onJoinResetMoney) {
		this.onJoinResetMoney = onJoinResetMoney;
	}
	/**
	 * @param onLeaveResetEnderChest
	 *            the onLeaveResetEnderChest to set
	 */
	...
	/**
	 * @param removeMobsWhitelist
	 *            the removeMobsWhitelist to set
	 */
	public void setRemoveMobsWhitelist(Set<EntityType> removeMobsWhitelist) {
		this.removeMobsWhitelist = removeMobsWhitelist;
	}
	/**
	 * @param requireConfirmationToSetHomeInNether
	 *            the requireConfirmationToSetHomeInNether to set
	 */
	 ...
	 *            the requireConfirmationToSetHomeInTheEnd to set
	 */
	...
	/**
	 * @param seaHeight
	 *            the seaHeight to set
	 */
	public void setSeaHeight(int seaHeight) {
		this.seaHeight = seaHeight;
	}
	/**
	 * @param netherSeaHeight
	 *            the netherSeaHeight to set
	 */
	...
	/**
	 * @param endSeaHeight
	 *            the endSeaHeight to set
	 */
	public void setEndSeaHeight(int endSeaHeight) {
		this.endSeaHeight = endSeaHeight;
	}
	/**
	 * @param teamJoinDeathReset
	 *            the teamJoinDeathReset to set
	 */
	...
	/**
	 * @param useOwnGenerator
	 *            the useOwnGenerator to set
	 */
	...
	/**
	 * @param visitorBannedCommands
	 *            the visitorbannedcommands to set
	 */
	...
	/**
	 * @param fallingBannedCommands
	 *            the fallingBannedCommands to set
	 */
	...
	/**
	 * @param acidDamageSnow
	 *            the acidDamageSnow to set
	 */
	...
	/**
	 * @param deathsResetOnNewIsland
	 *            the deathsResetOnNewIsland to set
	 */
	...
	/**
	 * @param onJoinCommands
	 *            the onJoinCommands to set
	 */
	...
	/**
	 * @param onLeaveCommands
	 *            the onLeaveCommands to set
	 */
	 ...
	 *
	 * @param onRespawnCommands
	 *            the on respawn commands
	 */
	...
	/**
	 * @param onJoinResetHealth
	 *            the onJoinResetHealth to set
	 */
	...
	/**
	 * @param onJoinResetHunger
	 *            the onJoinResetHunger to set
	 */
	...
	/**
	 * @param onLeaveResetHealth
	 *            the onLeaveResetHealth to set
	 */
	...
	/**
	 * @param onLeaveResetHunger
	 *            the onLeaveResetHunger to set
	 */
	...
	/**
	 * @param onLeaveResetXP
	 *            the onLeaveResetXP to set
	 */
	...
	/**
	 * @param createIslandOnFirstLoginEnabled
	 *            the createIslandOnFirstLoginEnabled to set
	 */
	...
	/**
	 * @param createIslandOnFirstLoginDelay
	 *            the createIslandOnFirstLoginDelay to set
	 */
	...
	/**
	 * @param createIslandOnFirstLoginAbortOnLogout
	 *            the createIslandOnFirstLoginAbortOnLogout to set
	 */
	...
	/**
	 * @param pasteMissingIslands
	 *            the pasteMissingIslands to set
	 * @since 1.10.0
	 */
	...
	/**
	 * @param rainEffectDuation
	 *            the rainEffectDuation to set
	 */
	...
	/**
	 * @param acidEffectDuation
	 *            the acidEffectDuation to set
	 */
	...
	/**
	 * @param spawnLimitMonsters
	 *            the spawnLimitMonsters to set
	 */
	...
	/**
	 * @param spawnLimitAnimals
	 *            the spawnLimitAnimals to set
	 */
	...
	/**
	 * @param spawnLimitWaterAnimals
	 *            the spawnLimitWaterAnimals to set
	 */
	...
	/**
	 * @param spawnLimitAmbient
	 *            the spawnLimitAmbient to set
	 */
	 ...
	 *            the ticksPerAnimalSpawns to set
	 */
	 ...
	 *            the ticksPerMonsterSpawns to set
	 */
	...
	/**
	 * @param playerCommandAliases
	 *            the playerCommandAliases to set
	 */
	...
	/**
	 * @param adminCommandAliases
	 *            the adminCommandAliases to set
	 */
	...
	/**
	 * @param defaultNewPlayerAction
	 *            the defaultNewPlayerAction to set
	 */
	...
	/**
	 * @param defaultPlayerAction
	 *            the defaultPlayerAction to set
	 */
	...
	/**
	 * @param defaultNetherBiome
	 *            the defaultNetherBiome to set
	 */
	...
	/**
	 * @param defaultEndBiome
	 *            the defaultEndBiome to set
	 */
	...
	/**
	 * @param teleportPlayerToIslandUponIslandCreation
	 *            the teleportPlayerToIslandUponIslandCreation to set
	 */
	...
	/**
	 * @param mobLimitSettings
	 *            the mobLimitSettings to set
	 */
	 ...
	 * 
	 * @param makeNetherPortals
	 *            the make nether portals
	 */
	 ...
	 * 
	 * @param makeEndPortals
	 *            the make end portals
	 */
	...
	/**
	 * @param makeStructures
	 *            the makeStructures to set
	 */
	...
	/**
	 * @param makeDecorations
	 *            the makeDecorations to set
	 */
	...
	/**
	 * @param disallowTeamMemberIslands
	 *            the disallowTeamMemberIslands to set
	 */
	...
	/**
	 * @param concurrentIslands
	 *            the concurrentIslands to set
	 */

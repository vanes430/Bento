...
/**
 * This Request Handler allows other plugins to get access to top 10 player list
 * per particular world. Handler returns linked hashmap from TopTenData for
 * particular world.
 */
public class TopTenRequestHandler extends AddonRequestHandler {
	...
	public Object handle(Map<String, Object> map) {
		 ...
		 * What we will return:
		 * 
		 * - Empty map if invalid input - the map of top ten player UUIDs and their
		 * island levels. Can be less then 10.
		 */

		if (map == null || map.isEmpty() || map.get(WORLD_NAME) == null || !(map.get(WORLD_NAME) instanceof String)

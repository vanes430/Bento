...
/**
 * Stores the levels data of the user. A note - if this class is extended to
...
public class LevelsData implements DataObject {
	 ...
	 * 
	 * @see
	 * world.bentobox.bbox.database.objects.DataObject#setUniqueId(java.lang.String)
	 */
	@Override
	...
	/**
	 * Sets the island points to next level. This is calculated the last time the
	 * level was calculated and will not change dynamically.
	 * 
	 * @param world
	 *            - world where island is
	 * @param points
	...
	/**
	 * Get the points required to get to the next island level for this world. This
	 * is calculated when the island level is calculated and will not change
	 * dynamically.
	 * 
	 * @param world
	 *            - world

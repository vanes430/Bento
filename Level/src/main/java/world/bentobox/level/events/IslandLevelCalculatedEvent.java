...
/**
 * This event is fired after the island level is calculated and before the
 * results are saved. If this event is cancelled, results will saved, but not
 * communicated. i.e., the result will be silent.
 *
 * @author tastybento
 */

...
public class Results {
	...
	/*
	 * public long getInitialLevel() { return initialLevel.get(); }
	 * 
	 ...
	 */
	/*
	 * @Override public String toString() { return "Results [report=" + report +
	 * ", mdCount=" + mdCount + ", uwCount=" + uwCount + ", ncCount=" + ncCount +
	 * ", ofCount=" + ofCount + ", rawBlockCount=" + rawBlockCount +
	 * ", underWaterBlockCount=" + underWaterBlockCount + ", level=" + level +
	 * ", deathHandicap=" + deathHandicap + ", pointsToNextLevel=" +
	 * pointsToNextLevel + ", totalPoints=" + totalPoints + ", initialLevel=" +
	 * initialLevel + "]"; }
	 */
	/**
	 * @return the mdCount

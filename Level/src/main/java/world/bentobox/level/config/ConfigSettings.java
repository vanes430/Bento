...
public class ConfigSettings implements ConfigObject {
	...
	/**
	 * @param underWaterMultiplier
	 *            the underWaterMultiplier to set
	 */
	...
	/**
	 * @param concurrentIslandCalcs
	 *            the concurrentIslandCalcs to set
	 */
	...
	/**
	 * @param zeroNewIslandLevels
	 *            the zeroNewIslandLevels to set
	 */
	...
	/**
	 * @param calculationTimeout
	 *            the calculationTimeout to set
	 */
	...
	/**
	 * @param logReportToConsole
	 *            if logReportToConsole should be shown on console
	 */
	...
	/**
	 * @param disableItemsAdder
	 *            the disableItemsAdder to set
	 */

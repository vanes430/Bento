 ...
 * Selection rules:
 * <ul>
 * <li>If the player has no border type metadata, the add-on default is
 * used.</li>
 * <li>If the metadata id is unknown or not enabled, the add-on default is
 * used.</li>
...
public final class PerPlayerBorderProxy implements BorderShower {
	...
	/**
	 * @param addon
	 *            owning add-on providing settings and available types
	 * @param customBorder
	 *            custom border renderer (barrier-based)
	 * @param vanillaBorder
	 *            vanilla world border renderer
	 */
